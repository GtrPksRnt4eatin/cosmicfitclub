...
class Door < Sinatra::Base
  ...
  post('/up', :auth=> 'door') do
    RestClient.patch( 'http://cosmicfitclub.ddns.net:5000/api/v1/pin/26', '{ "value": 1 }', :content_type => 'application/json' )
    sleep(0.5)
    RestClient.patch( 'http://cosmicfitclub.ddns.net:5000/api/v1/pin/26',  '{ "value": 0 }', :content_type => 'application/json' )
