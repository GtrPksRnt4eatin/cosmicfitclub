...
module Sinatra
  ...
  module ViewHelpers
    ...
    def covid19
      "\n<div id='covid19' style='background:rgba(255,80,0,0.6); padding:0.5em; text-align: center; font-size: 1em; font-family:\"Industry-Bold\";' ><a style='text-decoration:none;' href='/covid19'>Effective Tuesday March 17 Cosmic Fit Club will be suspending all classes due to COVID-19.</a></div>"
    end
