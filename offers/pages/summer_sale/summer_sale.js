...
function checkout(customer_id) {
  payment_form.checkout( customer_id, 15000, "Twelve Class Pack (end of summer sale)", null, function(payment_id) {
      $.post('/checkout/pack/buy', { customer_id: customer_id, pack_id: 11, payment_id: payment_id })
