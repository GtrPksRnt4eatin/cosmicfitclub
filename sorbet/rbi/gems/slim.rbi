...
class Slim::Parser < Temple::Parser
  ...
  def next_line; end
  def parse_attributes(attributes); end
...
class Slim::Filter < Temple::HTML::Filter
  ...
  def on_slim_embedded(type, content); end
...
class Slim::Embedded < Slim::Filter
  ...
  def on_slim_embedded(name, body); end
...
class Slim::Embedded::ERBEngine < Slim::Embedded::Engine
  def erb_parser; end
  def on_slim_embedded(engine, body); end
end
