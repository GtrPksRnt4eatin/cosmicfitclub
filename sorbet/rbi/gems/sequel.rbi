...
module Sequel::Plugins::ValidationHelpers::InstanceMethods
  def default_validation_helpers_options(type); end
  def validatable_attributes(atts, opts); end
  def validatable_attributes_for_type(type, atts, opts, &block); end
  def validates_exact_length(exact, atts, opts = nil); end
  def validates_format(with, atts, opts = nil); end
  def validates_includes(set, atts, opts = nil); end
  def validates_integer(atts, opts = nil); end
  def validates_length_range(range, atts, opts = nil); end
  def validates_max_length(max, atts, opts = nil); end
  def validates_min_length(min, atts, opts = nil); end
  def validates_not_null(atts, opts = nil); end
  def validates_numeric(atts, opts = nil); end
  def validates_operator(operator, rhs, atts, opts = nil); end
  def validates_presence(atts, opts = nil); end
  def validates_schema_types(atts = nil, opts = nil); end
  def validates_type(klass, atts, opts = nil); end
  def validates_unique(*atts); end
  def validation_error_message(message, *args); end
end
class User < Sequel::Model
  def confirmation; end
  def confirmation=(arg0); end
  def password; end
...
class Sequel::Postgres::PGArray < Anonymous_Delegator_40
...
class Sequel::Postgres::JSONArrayBase < Anonymous_Delegator_41
  def sql_literal_append(ds, sql); end
  include Sequel::SQL::AliasMethods
  include Sequel::SQL::CastMethods
end
...
class Sequel::Postgres::JSONHashBase < Anonymous_Delegator_42
  def sql_literal_append(ds, sql); end
  def to_hash; end
  include Sequel::SQL::AliasMethods
  include Sequel::SQL::CastMethods
...
module Sequel::ConnectionValidator
  def acquire(*a); end
  def checkin_connection(*arg0); end
  def connection_validation_timeout; end
  def connection_validation_timeout=(arg0); end
  def disconnect_connection(conn); end
  def self.extended(pool); end
end
class Sequel::ConnectionValidator::Retry < Sequel::Error
end
...
module Sequel::Plugins::JsonSerializer::ClassMethods
  def array_from_json(json, opts = nil); end
  def freeze; end
  def from_json(json, opts = nil); end
  def inherited_instance_variables; end
  def json_serializer_opts; end
  def to_json(*args, &block); end
end
module Sequel::Plugins::JsonSerializer::InstanceMethods
  def from_json(json, opts = nil); end
  def from_json_node(hash, opts = nil); end
  def json_serializer_opts(opts = nil); end
  def to_json(*a); end
end
...
class Sequel::Plugins::PgArrayAssociations::ManyToPgArrayAssociationReflection < Sequel::Model::Associations::AssociationReflection
  def array_type; end
  def associated_object_keys; end
  def can_have_associated_objects?(obj); end
  def default_key; end
...
class Sequel::Plugins::PgArrayAssociations::PgArrayToManyAssociationReflection < Sequel::Model::Associations::AssociationReflection
  def array_type; end
  def associated_object_keys; end
  def can_have_associated_objects?(obj); end
  def dataset_need_primary_key?; end
...
module Sequel::Plugins::PgArrayAssociations::ClassMethods
  def def_many_to_pg_array(opts); end
  def def_pg_array_to_many(opts); end
  def many_to_pg_array(name, opts = nil, &block); end
  def pg_array_to_many(name, opts = nil, &block); end
end
module Sequel::Plugins::PgArrayAssociations::DatasetMethods
  def many_to_pg_array_association_filter_expression(op, ref, obj); end
  def pg_array_to_many_association_filter_expression(op, ref, obj); end
end
class ClassdefSchedule < Sequel::Model
  extend Sequel::Plugins::PgArrayAssociations::ClassMethods
  include Anonymous_Module_43
end
module Anonymous_Module_43
  def _add_teacher(o); end
  def _remove_all_teachers; end
  def _remove_teacher(o); end
  def add_teacher(o, *args); end
  def remove_all_teachers(*args); end
  def remove_teacher(o, *args); end
  def teachers(dynamic_opts = nil, &block); end
  def teachers_dataset; end
end
