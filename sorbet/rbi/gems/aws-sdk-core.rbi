...
class InvalidName___Class_0x00___CodeLiteral_5 < String
  def inspect; end
end
...
class Net::HTTP < Net::Protocol
  def old_transport_request(req); end
  include Seahorse::Client::NetHttp::Patches::Ruby_2
end
...
class Aws::Errors::ServiceError < RuntimeError
  def code; end
  def context; end
  def initialize(context, message); end
  def self.code; end
...
class Aws::STS::Types::AssumeRoleRequest < Anonymous_Struct_6
  include Aws::Structure
end
...
class Aws::STS::Types::AssumeRoleResponse < Anonymous_Struct_7
  include Aws::Structure
end
...
class Aws::STS::Types::AssumeRoleWithSAMLRequest < Anonymous_Struct_8
  include Aws::Structure
end
...
class Aws::STS::Types::AssumeRoleWithSAMLResponse < Anonymous_Struct_9
  include Aws::Structure
end
...
class Aws::STS::Types::AssumeRoleWithWebIdentityRequest < Anonymous_Struct_10
  include Aws::Structure
end
...
class Aws::STS::Types::AssumeRoleWithWebIdentityResponse < Anonymous_Struct_11
  include Aws::Structure
end
...
class Aws::STS::Types::AssumedRoleUser < Anonymous_Struct_12
  include Aws::Structure
end
...
class Aws::STS::Types::Credentials < Anonymous_Struct_13
  include Aws::Structure
end
...
class Aws::STS::Types::DecodeAuthorizationMessageRequest < Anonymous_Struct_14
  include Aws::Structure
end
...
class Aws::STS::Types::DecodeAuthorizationMessageResponse < Anonymous_Struct_15
  include Aws::Structure
end
...
class Aws::Plugins::RetryErrors::Handler < Seahorse::Client::Handler
  ...
  def retryable?(context, error); end
...
class Aws::Plugins::StubResponses::Handler < Seahorse::Client::Handler
  def apply_stub(stub, response); end
  def call(context); end
  def signal_error(error, http_resp); end
  def signal_http(stub, http_resp); end
end
