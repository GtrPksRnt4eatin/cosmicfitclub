...
module GiftCert
  ...
  def GiftCert::generate_tall(cert_id)
    ...
    @@image.draw_paragraph({ text: "From:\r\nTo:\r\nFor:", ptsize: 12, x_offset: 840, y_offset: box_starty+18, gravity: "northeast", color: "\#FFFFFFFF", spacing: 75})
    @@image.draw_paragraph({ text: "#{cert.from}\r\n#{cert.to}\r\n#{cert.occasion}", ptsize: 12, x_offset: 300, y_offset: box_starty+18, gravity: "northwest", color: "\#000000FF", spacing: 75})
